    ...
    return (
        <div className='max-w-lg mx-auto p-3 w-full'>
            ...
            <form className='flex flex-col gap-4'>
                ...
                <Button className="bg-gradient-to-br from-purple-600 to-blue-500 text-white hover:bg-gradient-to-bl focus:ring-blue-300 dark:focus:ring-blue-800" type='submit' >Update
                </Button>
            </form>
